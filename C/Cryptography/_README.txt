...
*1. The file name must be "UpperCammelCase". Example: "CaesarCipher.c"
*2. Make sure the filename for the algorithm is same across other programming language files like "CaesarCipher.c" and "CaesarCipher.js"
