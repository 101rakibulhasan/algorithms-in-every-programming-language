Rules before commiting in MATLAB :
NOTE : Rules that have " * " is mandatory to follow to ger your pull request accepted

*1. The file name must be "UpperCammelCase". Example: "CaesarCipher.m"
*2. Make sure the filename for the algorithm is same across other programming language files like "CaesarCipher.m" and "CaesarCipher.js"
