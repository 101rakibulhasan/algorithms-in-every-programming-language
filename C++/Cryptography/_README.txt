...
*1. The file name must be "UpperCammelCase". Example: "CaesarCipher.cpp"
*2. Make sure the filename for the algorithm is same across other programming language files like "CaesarCipher.cpp" and "CaesarCipher.js"
